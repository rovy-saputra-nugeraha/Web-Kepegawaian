	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/log.jpg" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text">BIKN||KEPRI</span>
			</a>
			...
			<div class="float-right d-none d-sm-block">
			 &copy;
				<a target="_blank" href="https://www.bkn.go.id/layanan/simpegnas/">
					<strong>BIKN || Sistem Informasi Kepegawaian</strong>
				</a>
			</div>
			<b>Project 2023</b>
		</footer>
